...
class PiNetLinearNeck(BaseModule):
    ...
    def __init__(self,
                 ...
                 out_channels: int,
                 gap_dim: int = 0,
                 norm_cfg: Optional[dict] = None, ###### PI-NET
        ...
        torch.nn.init.constant_(self.fc.weight, 0.00001)
        self.fc_2 = nn.Linear(in_features=in_channels, out_features=out_channels, bias=False)
        torch.nn.init.constant_(self.fc_2.weight, 0.00001)
