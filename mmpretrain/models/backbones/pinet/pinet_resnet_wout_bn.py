    ...
    def __init__(self,
        ...
        layers.append(
            block(
                ...
                conv_cfg=conv_cfg,
                norm_cfg=norm_cfg,
                drop_path_rate=drop_path_rate[0],  # SUS
                **kwargs))
        ...
        for i in range(1, num_blocks):
            layers.append(
                block(
                    ...
                    conv_cfg=conv_cfg,
                    norm_cfg=norm_cfg,
                    drop_path_rate=drop_path_rate[i],  # SUS
                    **kwargs))
        super(ResLayer, self).__init__(*layers)


@MODELS.register_module()  # SUS
class PiNetResNetWoutBN(BaseBackbone):
    """ResNet backbone.
    ...
    def __init__(self,
                 ...
                 drop_path_rate=0.0):
        super(PiNetResNetWoutBN, self).__init__(init_cfg)
        ...
        for i, num_blocks in enumerate(self.stage_blocks):
            ...
            res_layer = self.make_res_layer(
                ...
                conv_cfg=conv_cfg,
                norm_cfg=norm_cfg,
                drop_path_rate=dpr[:num_blocks])  # SUS
            _in_channels = _out_channels
            _out_channels *= 2
            dpr = dpr[num_blocks:]  # SUS
    ...
    def init_weights(self):
        super(PiNetResNetWoutBN, self).init_weights()
    ...
    def train(self, mode=True):
        super(PiNetResNetWoutBN, self).train(mode)
        self._freeze_stages()
...
@MODELS.register_module()  # SUS
class PiNetResNetV1cWoutBN(PiNetResNetWoutBN):
    """ResNetV1c backbone.
    ...
    def __init__(self, **kwargs):
        super(PiNetResNetV1cWoutBN, self).__init__(
            deep_stem=True, avg_down=False, **kwargs)


@MODELS.register_module()
class PiNetResNetV1dWoutBN(PiNetResNetWoutBN):
    """ResNetV1d backbone.
    ...
    def __init__(self, **kwargs):
        super(PiNetResNetV1dWoutBN, self).__init__(
