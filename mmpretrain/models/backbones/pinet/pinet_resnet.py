...
class PiNetResNet(BaseBackbone):
    """ResNet backbone.
    ...
    def __init__(self,
                 ...
                 drop_path_rate=0.0):
        super(PiNetResNet, self).__init__(init_cfg)
    ...
    def init_weights(self):
        super(PiNetResNet, self).init_weights()
    ...
    def train(self, mode=True):
        super(PiNetResNet, self).train(mode)
        self._freeze_stages()
...
@MODELS.register_module() # SUS
class PiNetResNetV1c(PiNetResNet):
    """ResNetV1c backbone.
    ...
    def __init__(self, **kwargs):
        super(PiNetResNetV1c, self).__init__(
            deep_stem=True, avg_down=False, **kwargs)


@MODELS.register_module()
class PiNetResNetV1d(PiNetResNet):
    """ResNetV1d backbone.
    ...
    def __init__(self, **kwargs):
        super(PiNetResNetV1d, self).__init__(
